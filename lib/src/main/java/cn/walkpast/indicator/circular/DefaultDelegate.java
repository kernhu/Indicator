...
import cn.walkpast.indicator.listener.SimpleAnimatorListener;
...
public class DefaultDelegate implements PBDelegate {
    ...
    private CircularLimeIndicatorDrawable.OnEndListener mOnEndListener;

    public DefaultDelegate(@NonNull CircularLimeIndicatorDrawable parent,
    ...
    private void setupAnimations() {
        ...
        mRotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float angle = CircularLimeIndicatorUtils.getAnimatedFraction(animation) * 360f;
        ...
        mSweepAppearingAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                float animatedFraction = CircularLimeIndicatorUtils.getAnimatedFraction(animation);
                float angle;
        ...
        mEndAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                setEndRatio(1f - CircularLimeIndicatorUtils.getAnimatedFraction(animation));
    ...
    public void progressiveStop(CircularLimeIndicatorDrawable.OnEndListener listener) {
        ...
        mEndAnimator.addListener(new SimpleAnimatorListener() {
            ...
            public void onPreAnimationEnd(Animator animation) {
                ...
                CircularLimeIndicatorDrawable.OnEndListener endListener = mOnEndListener;
                mOnEndListener = null;
